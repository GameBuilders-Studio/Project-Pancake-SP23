...
[CustomEditor(typeof(UniqueBehaviourCollection<>), true)]
public class BehaviourCollectionEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        if (_type == null)
        {
            ...
            while (!IsSubclassOfRawGeneric(typeof(UniqueBehaviourCollection<>), _type))
            {
        ...
        var _noDuplicates = serializedObject.FindProperty("NoDuplicates");

        if (!_noDuplicates.boolValue)
        {
